...
if [[ "$ARCH" == "arm64" ]]; then
    DOWNLOAD_URL="https://github.com/Musixal/Backhaul/releases/download/v0.1/backhaul_linux_arm64.tar.gz"
elif [[ "$ARCH" == "amd64" ]]; then
    DOWNLOAD_URL="https://github.com/Musixal/Backhaul/releases/download/v0.1/backhaul_linux_amd64.tar.gz"
else
